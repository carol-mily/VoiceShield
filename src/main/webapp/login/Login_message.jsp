...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,url: 'http://localhost:8080/test_war_exploded/Client_Login_Controller.GetLoginList'
            ,cols: [[
                {field:'client_login_ID', title: 'ID', width:'30%', sort: true, fixed: true}
                ,{field:'client_login_password', title: '密码', width:'30%', sort: true}
