...
<form class="layui-form" method="post" action="http://localhost:8080/test_war_exploded/Client_Controller.AddClient">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="client_user_password" required lay-verify="required" autocomplete="off" class="layui-input" type="text">
            </div>
        </div>
        <br><br/>
        <div class="layui-inline">
            <div class="layui-input-block">
                <button class="layui-btn" action="Client_Controller.AddClient" onsubmit="return abc()" lay-filter="">立即提交</button>
            </div>
        </div>
    </div>
</form>
