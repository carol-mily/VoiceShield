...
<div class="layui-row layui-col-space10 panel_box">
    <div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
        <a href="javascript:;" data-url="${pageContext.request.contextPath}/Client">
    ...
    <div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
        <a href="javascript:;" data-url="${pageContext.request.contextPath}/Noise">
            <div class="panel_icon layui-bg-red">
                <i class="layui-anim seraph iconfont" data-icon="&#xe6eb;"></i>
            </div>
            <div class="panel_word userAll">
                <span>噪声库</span>
                <em>噪声管理</em>
                <cite class="layui-hide">总噪声库</cite>
            </div>
        </a>
    </div>
    <div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
    ...
    <div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
        <a href="javascript:;" data-url="${pageContext.request.contextPath}/Admit">
            <div class="panel_icon layui-bg-black">
                <i class="layui-anim seraph icon-icon10" data-icon="icon-icon10"></i>
            </div>
            <div class="panel_word userAll">
                <span>列表</span>
                <em>管理人管理</em>
                <cite class="layui-hide">管理人列表</cite>
            </div>
        </a>
    </div>
    <div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
