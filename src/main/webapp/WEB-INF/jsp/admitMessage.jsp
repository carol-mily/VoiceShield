        ...
        <form class="layui-form">
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" class="layui-input searchVal" placeholder="请输入搜索的管理人" />
                </div>
                <a class="layui-btn search_btn" data-type="reload">搜索</a>
            </div>
            <div class="layui-inline">
                <a class="layui-btn layui-btn-normal addNews_btn">添加管理人</a>
            </div>
            <div class="layui-inline">
...
<script>
    layui.use(['form','layer','table','laytpl'],function(){
        ...
        var tableIns = table.render({
            elem: '#userList',
            url : '${pageContext.request.contextPath}/table/user.do',
            cellMinWidth : 95,
            page : true,
            height : "full-125",
            limits : [10,15,20,25],
            ...
            cols : [[
                ...
                {field: 'lastlogtime', title: '最后登录时间', align:'center',minWidth:150},
